...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-12 items-center justify-center rounded-full bg-fcu-primary-50 p-1 text-muted-foreground',
      className
    )}
    {...props}
  />
